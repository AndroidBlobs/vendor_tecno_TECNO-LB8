...
#BSP:modify LBBHLYYL-1 by cheng.wang 20190408 start
#BSP:modified LBBHLYYL-49 by cheng.wang 20190412 start
BOOT_LOGO = hdplus1548
#BSP:modified LBBHLYYL-49 by cheng.wang 20190412 end
#BSP:modify LBBHLYYL-1 by cheng.wang 20190408 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
BUILD_PRELOADER = yes
BUILD_UBOOT = no
#BSP: add custom macro by wanghanfeng 20190318 start
CUSTOM_BUILD_VERNO = CY-LB8-H6110-A
#BSP: add custom macro by wanghanfeng 20190318 end
...
#[ITD] add LBBHLYYL-1642 by jiehua.chen 20190618 start
CUSTOM_SKIN_COLOR_COMPATIBLE = yes
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6b_mipi_raw s5k3l6sub_mipi_raw s5k3l6bsub_mipi_raw sp250a_mipi_raw sp250ab_mipi_raw gc8034main_mipi_raw gc8034mainb_mipi_raw
#[ITD] add LBBHLYYL-1642 by jiehua.chen 20190618 end
CUSTOM_TRAN_CAM_MATERIAL_CODE = s5k3l6_17201563 s5k3l6_17201574 sp250a_17201564 gc8034_17201548
CUSTOM_HAL_LENS = dw9718saf fp5510ee4af
#[ITD] add LBBHLYYL-1642 by jiehua.chen 20190618 start
CUSTOM_HAL_MAIN2_IMGSENSOR = sp250a_mipi_raw sp250ab_mipi_raw
CUSTOM_TRAN_HAL_SUB2_IMGSENSOR = gc8034main_mipi_raw gc8034mainb_mipi_raw
#[ITD] add LBBHLYYL-1642 by jiehua.chen 20190618 end
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9718saf
#[ITD] add LBBHLYYL-1642 by jiehua.chen 20190618 start
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l6_mipi_raw s5k3l6b_mipi_raw
#[ITD] add LBBHLYYL-1642 by jiehua.chen 20190618 end
...
#[ITD] add LBBHLYYL-1642 by jiehua.chen 20190618 start
CUSTOM_HAL_SUB_IMGSENSOR = s5k3l6sub_mipi_raw s5k3l6bsub_mipi_raw
#[ITD] add LBBHLYYL-1642 by jiehua.chen 20190618 end
CUSTOM_HAL_SUB_LENS =
#ITD: Modify Camera BringUp By ISP Team Start
CUSTOM_HIFI_SENSORS = no
#BSP: add LBBHLYYL-4 by changliang.guo 20190409 start
...
#BSP: add LBBHLYYL-4 by changliang.guo 20190409 end
...
#ITD: Modify Camera BringUp By ISP Team Start
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6sub_mipi_raw sp250a_mipi_raw gc8034main_mipi_raw
MTK_CAM_MAX_NUMBER_OF_CAMERA = 4
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9718saf fp5510ee4af
...
#TSD: modify LBBHLYYL-5 by chaochao.he 20190321 start
CUSTOM_MODEM=lb8_h6110_a1
#TSD: modify LBBHLYYL-5 by chaochao.he 20190321 end
...
LCM_WIDTH = 720
#BSP:modify LBBHLYYL-1 by cheng.wang 20190408 end
#BSP:add LBBHLYYL-1 by cheng.wang 20190326 start
TRAN_LCM_SUPPORT = yes
#BSP:add LBBHLYYL-1 by cheng.wang 20190326 end
...
#BSP:modify LBBHLYYL-3 baihaiping 20190321 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify LBBHLYYL-3 baihaiping 20190321 end
...
#SID1: add LBBHLYYL-30 by yehui.xu 2019.03.28 start
MTK_BUILD_VERNO=LB8-H6110ABC-P-190628V167
FINGERPRINT_BUILD_VERNO=ABC-190628V167
#SID1: add LBBHLYYL-30 by yehui.xu 2019.03.28 end
MTK_BWC_SUPPORT = yes
#TSD: modify LBBHLYYL-5 by chaochao.he 20190321 start
MTK_C2K_LTE_MODE = 0
#TSD: modify LBBHLYYL-5 by chaochao.he 20190321 end
...
#ITD:add cam  wide_tag by yuanchen.qiu 20190402 start
...
#ITD:add cam  wide_tag by yuanchen.qiu 20190402 end
...
#SID1: add LBBHLYYL-30 by yehui.xu 2019.03.28 start
MTK_CTA_SET = no
#SID1: LBBHLYYL-30 by yehui.xu 2019.03.28 end
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
...
#BSP:add LBBHLYYL-8 by yongxian.wang 20190322 start
MTK_DUAL_CHARGER_SUPPORT = no
#BSP:add LBBHLYYL-8 by yongxian.wang 20190322 end
...
#TSD modify CBQHLES-305 by chenchen 2019.04.01 start
MTK_ETWS_SUPPORT = yes
#TSD modify CBQHLES-305 by chenchen 2019.04.01 end
...
#BSP:modify LBBHLYYL-13 by di.qian 20190322 start
MTK_FACTORY_MODE_IN_GB2312 = no
#BSP:modify LBBHLYYL-13 by di.qian 20190322 end
#BSP: add LBBHLYYL-16 by jun.fang1 20190325 start
TRAN_RECOVERY_NOTCH_SUPPORT = yes
#BSP: add LBBHLYYL-16 by jun.fang1 20190325 end
...
#TSD:modify LBBHLYYL-119 haisong.quan 20190419 start
MTK_FM_SHORT_ANTENNA_SUPPORT = yes
#TSD:modify LBBHLYYL-119 haisong.quan 20190419 end
MTK_FM_SUPPORT = yes
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
# BSP: modify LBBHLYYL-46 by fengshan.wang 20190408 start
MTK_UART_USB_SWITCH = yes
# BSP: modify LBBHLYYL-46 by fengshan.wang 20190408 end
MTK_UCE_SUPPORT = no
MTK_UFS_BOOTING = no
MTK_UFS_OTP = no
...
#BSP: add build error by wanghanfeng 20190318 start
MTK_WAPI_SUPPORT = no
#BSP: add build error by wanghanfeng 20190318 end
...
CUSTOM_TRAN_PROJECT=tran_lb8
CUSTOM_TRAN_BOM=tran_lb8_a1
#BSP: add custom macro by wanghanfeng 20190318 end
#BSP: add LBBHLYYL-19 by yong.jiang 20190325 start
TRAN_FINGERPRINT_SUPPORT = sunwave_tee
#BSP: add LBBHLYYL-19 by yong.jiang 20190325 end
#BSP:add LBBHLYYL-7 by yongxian.wang 20190322 start
TRAN_CHARGER_SW_OTG_SUPPORT = yes
TRAN_CHARGER_OTG_LPO_SUPPORT = yes
TRAN_LED_BLUE_SUPPORT = yes
#BSP:add LBBHLYYL-7 by yongxian.wang 20190322 end
#BSP: enable cache persist tranfs tkv WP for lb8 by shentao 20190320 start
TRAN_USE_CUSTOM_FS = yes
TRAN_TKV_SUPPORTED=yes
#BSP: enable cache persist tranfs tkv WP for lb8 by shentao 20190320 end
#APP: add liye 20190329 start
include $(LOCAL_PATH)/ProjectConfig_APP.mk
#APP: add liye 20190329 end
#CAMAP: add CAMERAEYL-321 shiyang.zhang 20190411 start
include $(LOCAL_PATH)/ProjectConfig_CDD.mk
#CAMAP: add CAMERAEYL-321 shiyang.zhang 20190411 end
#BSP: add LBBHLYYL-18 by jun.fang1 20190325 start
...
#BSP:add LBBHLYYL-18 by jun.fang1 20190325 end
#add LBBHLYYL-31 by zhengbo.tang 20190328 start
TRAN_TP_SUPPORT = yes
#add LBBHLYYL-31 by zhengbo.tang 20190328 end
#BSP: add LBBHLYYL-58 by ka.fang 20190411 start
TRAN_SYSTEM_DEVINFO=yes
#BSP: add LBBHLYYL-58 by ka.fang 20190411 end
#ITD:add cam 3pty function XWWYLHLYS-302 by xiaoxue.cai 20190415 start
TRAN_CAMERA_FEATURE = yes
#ITD:add cam 3pty function XWWYLHLYS-302 by xiaoxue.cai 20190415 end
...
#PPD add by chunlei.zhuang for ppd feature at 20190418 start
include $(LOCAL_PATH)/ProjectConfig_PPD.mk
#PPD add by chunlei.zhuang for ppd feature at 20190418 end
#TSD:modify LBBHLYYL-119 haisong.quan 20190419 start
TRAN_SHORT_ANTENNA_SUPPORT=yes
#TSD:modify LBBHLYYL-119 haisong.quan 20190419 end

#APP:add LBBHLYYL-196 by gege.huang 20190425 start
TRAN_FACEBOOKMESSENGER_NO_SIGN = yes
#APP:add LBBHLYYL-196 by gege.huang 20190425 end

#PPD:modify f2fs for lb8 by fan.feng1 20190527 start 
TRAN_USE_F2FS = yes
#PPD:modify f2fs for lb8 by fan.feng1 20190527 end
